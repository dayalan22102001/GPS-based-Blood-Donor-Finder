...
public class CustomBaseAdapterforgetadmin extends BaseAdapter {
	Context con;
	LayoutInflater layoutInflater;
	ArrayList<HashMap<String, String>> listvalue;

	public CustomBaseAdapterforgetadmin(Forgetpswdadmin forgetpswdadmin,
			ArrayList<HashMap<String, String>> usersList) {
		// TODO Auto-generated constructor stub
		con = forgetpswdadmin;
		listvalue = usersList;
		layoutInflater = LayoutInflater.from(forgetpswdadmin);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = layoutInflater.inflate(R.layout.listviewforget, null);
