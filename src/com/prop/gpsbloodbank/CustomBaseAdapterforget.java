...
public class CustomBaseAdapterforget extends BaseAdapter {
	Context con;
	LayoutInflater layoutInflater;
	ArrayList<HashMap<String, String>> listvalue;

	public CustomBaseAdapterforget(Forgetpswd forgetpswd,
			ArrayList<HashMap<String, String>> usersList) {
		// TODO Auto-generated constructor stub
		con = forgetpswd;
		listvalue = usersList;
		layoutInflater = LayoutInflater.from(forgetpswd);
	}
